...
// dist/widgets/gimbal-widget.js
var import_widgets4 = require("@deck.gl/widgets");
var GimbalWidget = (props = {}) => {
  useWidget(import_widgets4.GimbalWidget, props);
  return null;
};
...
var GeocoderWidget = (props = {}) => {
  useWidget(import_widgets5._GeocoderWidget, props);
  return null;
};
...
var InfoWidget = (props) => {
  useWidget(import_widgets6.InfoWidget, props);
  return null;
};

// dist/widgets/popup-widget.js
var import_widgets7 = require("@deck.gl/widgets");
var PopupWidget = (props) => {
  useWidget(import_widgets7.PopupWidget, props);
  return null;
};
...
var ContextMenuWidget = (props) => {
  useWidget(import_widgets8.ContextMenuWidget, props);
  return null;
};

// dist/widgets/scrollbar-widget.js
var import_widgets9 = require("@deck.gl/widgets");
var ScrollbarWidget = (props = {}) => {
  useWidget(import_widgets9.ScrollbarWidget, props);
  return null;
};

// dist/widgets/icon-widget.js
var import_widgets10 = require("@deck.gl/widgets");
var IconWidget = (props) => {
  useWidget(import_widgets10.IconWidget, props);
  return null;
};

// dist/widgets/toggle-widget.js
var import_widgets11 = require("@deck.gl/widgets");
var ToggleWidget = (props) => {
  useWidget(import_widgets11.ToggleWidget, props);
  return null;
};

// dist/widgets/selector-widget.js
var import_widgets12 = require("@deck.gl/widgets");
var SelectorWidget = (props) => {
  useWidget(import_widgets12.SelectorWidget, props);
  return null;
};

// dist/widgets/loading-widget.js
var import_widgets13 = require("@deck.gl/widgets");
var LoadingWidget = (props = {}) => {
  useWidget(import_widgets13.LoadingWidget, props);
  return null;
};

// dist/widgets/reset-view-widget.js
var import_widgets14 = require("@deck.gl/widgets");
var ResetViewWidget = (props = {}) => {
  useWidget(import_widgets14.ResetViewWidget, props);
  return null;
};

// dist/widgets/scale-widget.js
var import_widgets15 = require("@deck.gl/widgets");
var ScaleWidget = (props = {}) => {
  useWidget(import_widgets15._ScaleWidget, props);
  return null;
};

// dist/widgets/screenshot-widget.js
var import_widgets16 = require("@deck.gl/widgets");
var ScreenshotWidget = (props = {}) => {
  useWidget(import_widgets16.ScreenshotWidget, props);
  return null;
};

// dist/widgets/splitter-widget.js
var import_widgets17 = require("@deck.gl/widgets");
var SplitterWidget = (props) => {
  useWidget(import_widgets17._SplitterWidget, props);
  return null;
};

// dist/widgets/theme-widget.js
var import_widgets18 = require("@deck.gl/widgets");
var ThemeWidget = (props = {}) => {
  useWidget(import_widgets18.ThemeWidget, props);
  return null;
};

// dist/widgets/timeline-widget.js
var import_widgets19 = require("@deck.gl/widgets");
var TimelineWidget = (props = {}) => {
  useWidget(import_widgets19._TimelineWidget, props);
  return null;
};

// dist/widgets/stats-widget.js
var import_widgets20 = require("@deck.gl/widgets");
var StatsWidget = (props = {}) => {
  useWidget(import_widgets20._StatsWidget, props);
  return null;
};
