...
var __exports__ = (() => {
  ...
  var uniformBlock = `layout(std140) uniform arcUniforms {
  bool greatCircle;
...
`;
  ...
  var uniformBlock2 = `layout(std140) uniform bitmapUniforms {
  vec4 bounds;
...
`;
  ...
  function unpackUVsFromRGB(color5) {
    const [u, v, fracUV] = color5;
  ...
  // src/icon-layer/icon-layer-uniforms.ts
  var uniformBlock3 = `layout(std140) uniform iconUniforms {
  float sizeScale;
...
`;
  ...
  // src/icon-layer/icon-layer.wgsl.ts
  var shaderWGSL = (
    /* wgsl */
    `struct IconUniforms {
  sizeScale: f32,
...
`
  ...
  var IconManager = class {
    ...
    _loadIcons(icons) {
      ...
      for (const icon of icons) {
        this._pendingCount++;
        (0, import_core5.load)(icon.url, this._loadOptions).then((imageData) => {
          const id = getIconId(icon);
  ...
  var IconLayer = class extends import_core7.Layer {
    getShaders() {
      return super.getShaders({ vs: icon_layer_vertex_glsl_default, fs: icon_layer_fragment_glsl_default, source: shaderWGSL, modules: [import_core7.project32, import_core7.color, import_core7.picking, iconUniforms] });
    }
    initializeState() {
      this.state = {
    ...
    draw({ uniforms }) {
      ...
      if (iconsTexture) {
        ...
        const iconProps = {
          ...
          sizeUnits: import_core7.UNIT[sizeUnits],
          sizeScale,
    ...
    _onError(evt) {
      ...
      if (onIconError) {
        ...
        import_core7.log.error(evt.error.message)();
      }
    }
  ...
  // src/line-layer/line-layer-uniforms.ts
...
`
  ...
  // src/line-layer/line-layer.wgsl.ts
  var shaderWGSL2 = (
    /* wgsl */
...
`;
  ...
  var LineLayer = class extends import_core8.Layer {
    getBounds() {
      return this.getAttributeManager()?.getBounds([
        "instanceSourcePositions",
        "instanceTargetPositions"
    ...
    getShaders() {
      return super.getShaders({ vs: line_layer_vertex_glsl_default, fs: line_layer_fragment_glsl_default, source: shaderWGSL2, modules: [import_core8.project32, import_core8.color, import_core8.picking, lineUniforms] });
    }
    // This layer has its own wrapLongitude logic
    get wrapLongitude() {
      return false;
    ...
    draw({ uniforms }) {
      ...
      const model = this.state.model;
      const lineProps = {
        widthUnits: import_core8.UNIT[widthUnits],
        widthScale,
        widthMinPixels,
        widthMaxPixels,
  ...
  // src/point-cloud-layer/point-cloud-layer-uniforms.ts
...
`;
  ...
  // src/point-cloud-layer/point-cloud-layer.wgsl.ts
...
`
  ...
  var PointCloudLayer = class extends import_core9.Layer {
    getShaders() {
      return super.getShaders({
        ...
        modules: [import_core9.project32, import_core9.color, import_core10.gouraudMaterial, import_core9.picking, pointCloudUniforms]
      });
    }
    initializeState() {
    ...
    draw({ uniforms }) {
      ...
      const pointCloudProps = {
        sizeUnits: import_core9.UNIT[sizeUnits],
  ...
  // src/scatterplot-layer/scatterplot-layer-uniforms.ts
...
`
  ...
  // src/scatterplot-layer/scatterplot-layer.wgsl.ts
...
`
  ...
  var ScatterplotLayer = class extends import_core11.Layer {
    getShaders() {
      return super.getShaders({
        vs: scatterplot_layer_vertex_glsl_default,
        fs: scatterplot_layer_fragment_glsl_default,
        source: scatterplot_layer_wgsl_default,
        modules: [import_core11.project32, import_core11.color, import_core11.picking, scatterplotUniforms]
      });
    }
    initializeState() {
      this.getAttributeManager().addInstanced({
    ...
    draw({ uniforms }) {
      ...
      const scatterplotProps = {
        ...
        radiusMinPixels,
        radiusMaxPixels,
        lineWidthUnits: import_core11.UNIT[lineWidthUnits],
        lineWidthScale,
        lineWidthMinPixels,
        lineWidthMaxPixels
      };
  ...
  var import_engine8 = __toESM(require_engine(), 1);

  // src/column-layer/column-geometry.ts
  var import_core12 = __toESM(require_core(), 1);
  var import_engine7 = __toESM(require_engine(), 1);
  ...
  function tesselateColumn(props) {
    ...
    let { vertices } = props;
    if (vertices) {
      import_core12.log.assert(vertices.length >= nradial);
  ...
  // src/column-layer/column-layer-uniforms.ts
  var uniformBlock4 = `layout(std140) uniform columnUniforms {
  float radius;
  float angle;
  vec2 offset;
  bool extruded;
...
`;
  ...
  var ColumnLayer = class extends import_core13.Layer {
    getShaders() {
      const defines = {};
      ...
      return super.getShaders({
        ...
        defines,
        modules: [import_core13.project32, flatShading ? import_core13.phongMaterial : import_core13.gouraudMaterial, import_core13.picking, columnUniforms]
      });
    }
    /**
    ...
    draw({ uniforms }) {
      ...
      const columnProps = {
        ...
        elevationScale,
        edgeDistance,
        radiusUnits: import_core13.UNIT[radiusUnits],
        widthUnits: import_core13.UNIT[lineWidthUnits],
  ...
  var import_engine9 = __toESM(require_engine(), 1);
  var defaultProps8 = {
  ...
  var GridCellLayer = class extends ColumnLayer {
    _updateGeometry() {
      const geometry = new import_engine9.CubeGeometry();
    ...
    draw({ uniforms }) {
      ...
      const columnProps = {
        radius: cellSize / 2,
        radiusUnits: import_core14.UNIT[radiusUnits],
        angle,
        offset,
        extruded,
        stroked: false,
  ...
  var import_engine10 = __toESM(require_engine(), 1);
  var import_engine11 = __toESM(require_engine(), 1);
  ...
  var END_CAP = 2;
  var INVALID = 4;
  var PathTesselator = class extends import_core15.Tesselator {
    constructor(opts) {
      super({
        ...opts,
        attributes: {
  ...
  // src/path-layer/path-layer-uniforms.ts
  var uniformBlock5 = `layout(std140) uniform pathUniforms {
  float widthScale;
  float widthMinPixels;
  float widthMaxPixels;
  float jointType;
...
`;
  ...
  var PathLayer = class extends import_core16.Layer {
    getShaders() {
      return super.getShaders({ vs: path_layer_vertex_glsl_default, fs: path_layer_fragment_glsl_default, modules: [import_core16.project32, import_core16.picking, pathUniforms] });
    }
    get wrapLongitude() {
      return false;
    }
    ...
    draw({ uniforms }) {
      ...
      const pathProps = {
        ...
        billboard,
        widthUnits: import_core16.UNIT[widthUnits],
        widthScale,
        miterLimit,
        widthMinPixels,
        widthMaxPixels
    ...
    _getModel() {
      ...
      return new import_engine11.Model(this.context.device, {
        ...this.getShaders(),
        id: this.props.id,
        bufferLayout: this.getAttributeManager().getBufferLayouts(),
        geometry: new import_engine10.Geometry({
          topology: "triangle-list",
          attributes: {
  ...
  var import_engine12 = __toESM(require_engine(), 1);
  ...
  var PolygonTesselator = class extends import_core17.Tesselator {
    constructor(opts) {
  ...
  // src/solid-polygon-layer/solid-polygon-layer-uniforms.ts
...
`;
  ...
  var SolidPolygonLayer = class extends import_core18.Layer {
    getShaders(type) {
      return super.getShaders({
        ...
        modules: [import_core18.project32, import_core18.gouraudMaterial, import_core18.picking, solidPolygonUniforms]
      });
    }
    get wrapLongitude() {
      return false;
    ...
    _getModels() {
      ...
      if (filled) {
        ...
        topModel = new import_engine12.Model(this.context.device, {
          ...shaders,
          id: `${id}-top`,
          topology: "triangle-list",
          bufferLayout,
      ...
      if (extruded) {
        ...
        sideModel = new import_engine12.Model(this.context.device, {
        ...
        wireframeModel = new import_engine12.Model(this.context.device, {
          ...this.getShaders("side"),
          id: `${id}-wireframe`,
          bufferLayout,
          geometry: new import_engine12.Geometry({
  ...
  var PolygonLayer = class extends import_core19.CompositeLayer {
    initializeState() {
      this.state = {
        paths: [],
        pathsDiff: null
      ...
      if (this.props.getLineDashArray) {
        import_core19.log.removed("getLineDashArray", "PathStyleExtension")();
      }
    }
    ...
    _getPaths(dataRange = {}) {
      ...
      const { iterable, objectInfo } = (0, import_core19.createIterable)(data, startRow, endRow);
      for (const object of iterable) {
        objectInfo.index++;
  ...
  // src/text-layer/multi-icon-layer/sdf-uniforms.ts
...
`;
  ...
  // src/text-layer/text-uniforms.ts
  var CONTENT_ALIGN = {
    none: 0,
    start: 1,
    center: 2,
...
`;
  ...
  // src/text-layer/multi-icon-layer/multi-icon-layer-vertex.glsl.ts
...
`;
  ...
  var MultiIconLayer = class extends IconLayer {
    getShaders() {
      ...
      return { ...shaders, modules: [...shaders.modules, textUniforms, sdfUniforms], vs: multi_icon_layer_vertex_glsl_default, fs: multi_icon_layer_fragment_glsl_default };
    }
    initializeState() {
    ...
    updateState(params) {
      ...
      if (!props.sdf && props.outlineWidth) {
        import_core20.log.warn(`${this.id}: fontSettings.sdf is required to render outline`)();
      }
    }
    draw(params) {
      const {
    ...
    calculateInstanceIconDefs(attribute, { startRow, endRow }) {
      ...
      const { iterable, objectInfo } = (0, import_core20.createIterable)(data, startRow, endRow);
      for (const object of iterable) {
        objectInfo.index++;
  ...
  function transformRow(line, startIndex, endIndex, iconMapping, leftOffsets, rowSize) {
    ...
    for (let i = startIndex; i < endIndex; i++) {
      ...
      if (frame) {
        ...
        import_core21.log.warn(`Missing character: ${character} (${character.codePointAt(0)})`)();
        leftOffsets[i] = x;
  ...
  function setFontAtlasCacheLimit(limit) {
    import_core22.log.assert(Number.isFinite(limit) && limit >= CACHE_LIMIT, "Invalid cache limit");
  ...
  var import_engine13 = __toESM(require_engine(), 1);
  var import_engine14 = __toESM(require_engine(), 1);

  // src/text-layer/text-background-layer/text-background-layer-uniforms.ts
...
`;
  ...
  var TextBackgroundLayer = class extends import_core23.Layer {
    getShaders() {
      return super.getShaders({
        vs: text_background_layer_vertex_glsl_default,
        fs: text_background_layer_fragment_glsl_default,
        modules: [import_core23.project32, import_core23.picking, textBackgroundUniforms, textUniforms]
      });
    }
    initializeState() {
      this.getAttributeManager().addInstanced({
    ...
    draw({ uniforms }) {
      ...
      const textBackgroundProps = {
        ...
        borderRadius,
        padding,
        sizeUnits: import_core23.UNIT[sizeUnits],
        sizeScale,
        sizeMinPixels,
        sizeMaxPixels
      };
  ...
  var TextLayer = class extends import_core24.CompositeLayer {
    constructor() {
      super(...arguments);
    ...
    initializeState() {
      ...
      if (this.props.maxWidth > 0) {
        import_core24.log.once(1, "v8.9 breaking change: TextLayer maxWidth is now relative to text size")();
      }
    }
    ...
    _updateText() {
      ...
      if (textBuffer && startIndices) {
        ...
        const { iterable, objectInfo } = (0, import_core24.createIterable)(data);
        startIndices = [0];
        numInstances = 0;
        for (const object of iterable) {
          objectInfo.index++;
  ...
  function getGeojsonFeatures(geojson) {
    ...
    import_core25.log.assert(geojson.type, "GeoJSON does not have type");
    switch (geojson.type) {
      case "Feature":
        return [geojson];
      case "FeatureCollection":
        import_core25.log.assert(Array.isArray(geojson.features), "GeoJSON does not have features array");
  ...
  function separateGeojsonFeatures(features, wrapFeature, dataRange = {}) {
    ...
    for (let featureIndex = startRow; featureIndex < endRow; featureIndex++) {
      ...
      if (geometry.type === "GeometryCollection") {
        import_core25.log.assert(Array.isArray(geometry.geometries), "GeoJSON does not have geometries array");
  ...
  function separateGeometry(geometry, separated, wrapFeature, sourceFeature, sourceFeatureIndex) {
    ...
    if (!validateGeometry(type, coordinates)) {
      import_core25.log.warn(`${type} coordinates are malformed`)();
      return;
    }
    switch (type) {
      case "Point":
  ...
  function validateGeometry(type, coordinates) {
    ...
    import_core25.log.assert(nestLevel, `Unknown GeoJSON type ${type}`);
  ...
  var GeoJsonLayer = class extends import_core26.CompositeLayer {
    initializeState() {
      this.state = {
        layerProps: {},
        features: {},
