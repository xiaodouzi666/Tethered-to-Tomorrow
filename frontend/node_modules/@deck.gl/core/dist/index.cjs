...
function checkVersion() {
  const version = true ? "9.3.1" : globalThis.DECK_VERSION || "untranspiled source";
...
var Deck = class {
  ...
  setProps(props) {
    ...
    if (props.useDevicePixels !== void 0 && ((_h = (_g = this.device) == null ? void 0 : _g.canvasContext) == null ? void 0 : _h.setProps)) {
