...
import type { TooltipContent } from "./tooltip-widget.js";
...
export default class Deck<ViewsT extends ViewOrViews = null> {
    ...
    protected tooltip: TooltipWidget | null;
    ...
    private _hoverPickSequence;
    private _pointerDownPickSequence;
    ...
    private _lastPointerDownInfoPromise;
    ...
    private _resolveInternalPickingMode;
    private _getInternalPickingMode;
    private _validateInternalPickingMode;
    private _getFirstPickedInfo;
    private _shouldUnproject3D;
    private _getPointPickOptions;
    private _pickPointSync;
    private _pickPointAsync;
    private _getLastPointerDownPickingInfo;
    private _applyHoverCallbacks;
    private _dispatchPickingEvent;
    private _pickAsync;
    private _pick;
