...
// node_modules/@deck.gl/layers/dist/icon-layer/icon-layer.wgsl.js
var shaderWGSL = (
  /* wgsl */
  `struct IconUniforms {
  sizeScale: f32,
...
var IconLayer = class extends layer_default {
  getShaders() {
    return super.getShaders({ vs: icon_layer_vertex_glsl_default, fs: icon_layer_fragment_glsl_default, source: shaderWGSL, modules: [project32_default, color_default, picking_default, iconUniforms] });
  }
  initializeState() {
    this.state = {
...
// node_modules/@deck.gl/layers/dist/text-layer/text-uniforms.js
var CONTENT_ALIGN = {
  none: 0,
  start: 1,
  center: 2,
...
// node_modules/@deck.gl/layers/dist/text-layer/multi-icon-layer/multi-icon-layer-vertex.glsl.js
...
var TextBackgroundLayer = class extends layer_default {
  getShaders() {
    return super.getShaders({
      ...
      modules: [project32_default, picking_default, textBackgroundUniforms, textUniforms]
    });
  }
  initializeState() {
    this.getAttributeManager().addInstanced({
