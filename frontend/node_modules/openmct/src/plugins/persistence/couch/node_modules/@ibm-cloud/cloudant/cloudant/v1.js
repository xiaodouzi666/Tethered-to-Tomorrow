...
var CloudantV1 = /** @class */ (function (_super) {
    ...
    CloudantV1.newInstance = function (options) {
        ...
        if (!options.authenticator) {
            options.authenticator = (0, getAuthenticatorFromEnvCloudantExtension_1.default)(options.serviceName);
        }
    ...
    CloudantV1.prototype.getServerInformation = function (params) {
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'getServerInformation');
        var parameters = {
            options: {
                url: '/',
                method: 'GET',
    ...
    CloudantV1.prototype.getMembershipInformation = function (params) {
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'getMembershipInformation');
        var parameters = {
            options: {
                url: '/_membership',
                method: 'GET',
    ...
    CloudantV1.prototype.getUuids = function (params) {
        var _params = __assign({}, params);
        var _requiredParams = [];
        var _validParams = ['count', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'getUuids');
        var parameters = {
            options: {
                url: '/_uuids',
                method: 'GET',
    ...
    CloudantV1.prototype.getCapacityThroughputInformation = function (params) {
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'getCapacityThroughputInformation');
        var parameters = {
            options: {
    ...
    CloudantV1.prototype.putCapacityThroughputConfiguration = function (params) {
        var _params = __assign({}, params);
        var _requiredParams = ['blocks'];
        var _validParams = ['blocks', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'putCapacityThroughputConfiguration');
        var parameters = {
            options: {
                url: '/_api/v2/user/capacity/throughput',
                method: 'PUT',
    ...
    CloudantV1.prototype.getDbUpdates = function (params) {
        var _params = __assign({}, params);
        var _requiredParams = [];
        var _validParams = ['feed', 'heartbeat', 'timeout', 'since', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'getDbUpdates');
        var parameters = {
            options: {
                url: '/_db_updates',
                method: 'GET',
    ...
    CloudantV1.prototype.postChanges = function (params) {
        var _params = __assign({}, params);
        var _requiredParams = ['db'];
        var _validParams = ['db', 'docIds', 'fields', 'selector', 'lastEventId', 'attEncodingInfo', 'attachments', 'conflicts', 'descending', 'feed', 'filter', 'heartbeat', 'includeDocs', 'limit', 'seqInterval', 'since', 'style', 'timeout', 'view', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'postChanges');
        var parameters = {
            options: {
                url: '/{db}/_changes',
                method: 'POST',
    ...
    CloudantV1.prototype.postChangesAsStream = function (params) {
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'postChangesAsStream');
        var parameters = {
            options: {
                url: '/{db}/_changes',
                method: 'POST',
    ...
    CloudantV1.prototype.headDatabase = function (params) {
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'headDatabase');
        var parameters = {
            options: {
                url: '/{db}',
                method: 'HEAD',
    ...
    CloudantV1.prototype.getAllDbs = function (params) {
        var _params = __assign({}, params);
        var _requiredParams = [];
        var _validParams = ['descending', 'endKey', 'limit', 'skip', 'startKey', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'getAllDbs');
        var parameters = {
            options: {
                url: '/_all_dbs',
                method: 'GET',
    ...
    CloudantV1.prototype.postDbsInfo = function (params) {
        var _params = __assign({}, params);
        var _requiredParams = ['keys'];
        var _validParams = ['keys', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'postDbsInfo');
        var parameters = {
            options: {
                url: '/_dbs_info',
                method: 'POST',
    ...
    CloudantV1.prototype.deleteDatabase = function (params) {
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'deleteDatabase');
        var parameters = {
            options: {
                url: '/{db}',
                method: 'DELETE',
    ...
    CloudantV1.prototype.getDatabaseInformation = function (params) {
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'getDatabaseInformation');
        var parameters = {
            options: {
                url: '/{db}',
                method: 'GET',
    ...
    CloudantV1.prototype.putDatabase = function (params) {
        var _params = __assign({}, params);
        var _requiredParams = ['db'];
        var _validParams = ['db', 'partitioned', 'q', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'putDatabase');
        var parameters = {
            options: {
                url: '/{db}',
                method: 'PUT',
    ...
    CloudantV1.prototype.headDocument = function (params) {
        var _params = __assign({}, params);
        var _requiredParams = ['db', 'docId'];
        var _validParams = ['db', 'docId', 'ifNoneMatch', 'latest', 'rev', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'headDocument');
        var parameters = {
            options: {
                url: '/{db}/{doc_id}',
                method: 'HEAD',
    ...
    CloudantV1.prototype.postDocument = function (params) {
        var _params = __assign({}, params);
        var _requiredParams = ['db', 'document'];
        var _validParams = ['db', 'document', 'contentType', 'batch', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'postDocument');
        var parameters = {
            options: {
                url: '/{db}',
                method: 'POST',
    ...
    CloudantV1.prototype.postAllDocs = function (params) {
        var _params = __assign({}, params);
        var _requiredParams = ['db'];
        var _validParams = ['db', 'attEncodingInfo', 'attachments', 'conflicts', 'descending', 'includeDocs', 'inclusiveEnd', 'limit', 'skip', 'updateSeq', 'endKey', 'key', 'keys', 'startKey', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'postAllDocs');
        var parameters = {
            options: {
                url: '/{db}/_all_docs',
                method: 'POST',
    ...
    CloudantV1.prototype.postAllDocsAsStream = function (params) {
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'postAllDocsAsStream');
        var parameters = {
            options: {
                url: '/{db}/_all_docs',
                method: 'POST',
    ...
    CloudantV1.prototype.postAllDocsQueries = function (params) {
        var _params = __assign({}, params);
        var _requiredParams = ['db', 'queries'];
        var _validParams = ['db', 'queries', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'postAllDocsQueries');
        var parameters = {
            options: {
    ...
    CloudantV1.prototype.postAllDocsQueriesAsStream = function (params) {
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'postAllDocsQueriesAsStream');
        var parameters = {
            options: {
                url: '/{db}/_all_docs/queries',
                method: 'POST',
    ...
    CloudantV1.prototype.postBulkDocs = function (params) {
        var _params = __assign({}, params);
        var _requiredParams = ['db', 'bulkDocs'];
        var _validParams = ['db', 'bulkDocs', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'postBulkDocs');
        var parameters = {
            options: {
                url: '/{db}/_bulk_docs',
                method: 'POST',
    ...
    CloudantV1.prototype.postBulkGet = function (params) {
        var _params = __assign({}, params);
        var _requiredParams = ['db', 'docs'];
        var _validParams = ['db', 'docs', 'attachments', 'attEncodingInfo', 'latest', 'revs', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'postBulkGet');
        var parameters = {
            options: {
                url: '/{db}/_bulk_get',
                method: 'POST',
    ...
    CloudantV1.prototype.postBulkGetAsMixed = function (params) {
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'postBulkGetAsMixed');
        var parameters = {
            options: {
                url: '/{db}/_bulk_get',
                method: 'POST',
    ...
    CloudantV1.prototype.postBulkGetAsRelated = function (params) {
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'postBulkGetAsRelated');
        var parameters = {
            options: {
                url: '/{db}/_bulk_get',
                method: 'POST',
    ...
    CloudantV1.prototype.postBulkGetAsStream = function (params) {
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'postBulkGetAsStream');
        var parameters = {
            options: {
                url: '/{db}/_bulk_get',
                method: 'POST',
    ...
    CloudantV1.prototype.deleteDocument = function (params) {
        var _params = __assign({}, params);
        var _requiredParams = ['db', 'docId'];
        var _validParams = ['db', 'docId', 'ifMatch', 'batch', 'rev', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'deleteDocument');
        var parameters = {
            options: {
                url: '/{db}/{doc_id}',
                method: 'DELETE',
    ...
    CloudantV1.prototype.getDocument = function (params) {
        var _params = __assign({}, params);
        var _requiredParams = ['db', 'docId'];
        var _validParams = ['db', 'docId', 'ifNoneMatch', 'attachments', 'attEncodingInfo', 'conflicts', 'deletedConflicts', 'latest', 'localSeq', 'meta', 'rev', 'revs', 'revsInfo', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'getDocument');
        var parameters = {
            options: {
                url: '/{db}/{doc_id}',
                method: 'GET',
    ...
    CloudantV1.prototype.getDocumentAsMixed = function (params) {
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'getDocumentAsMixed');
        var parameters = {
            options: {
                url: '/{db}/{doc_id}',
                method: 'GET',
    ...
    CloudantV1.prototype.getDocumentAsRelated = function (params) {
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'getDocumentAsRelated');
        var parameters = {
            options: {
                url: '/{db}/{doc_id}',
                method: 'GET',
    ...
    CloudantV1.prototype.getDocumentAsStream = function (params) {
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'getDocumentAsStream');
        var parameters = {
            options: {
                url: '/{db}/{doc_id}',
                method: 'GET',
    ...
    CloudantV1.prototype.putDocument = function (params) {
        var _params = __assign({}, params);
        var _requiredParams = ['db', 'docId', 'document'];
        var _validParams = ['db', 'docId', 'document', 'contentType', 'ifMatch', 'batch', 'newEdits', 'rev', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'putDocument');
        var parameters = {
            options: {
                url: '/{db}/{doc_id}',
                method: 'PUT',
    ...
    CloudantV1.prototype.headDesignDocument = function (params) {
        var _params = __assign({}, params);
        var _requiredParams = ['db', 'ddoc'];
        var _validParams = ['db', 'ddoc', 'ifNoneMatch', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'headDesignDocument');
        var parameters = {
            options: {
                url: '/{db}/_design/{ddoc}',
                method: 'HEAD',
    ...
    CloudantV1.prototype.deleteDesignDocument = function (params) {
        var _params = __assign({}, params);
        var _requiredParams = ['db', 'ddoc'];
        var _validParams = ['db', 'ddoc', 'ifMatch', 'batch', 'rev', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'deleteDesignDocument');
        var parameters = {
            options: {
                url: '/{db}/_design/{ddoc}',
                method: 'DELETE',
    ...
    CloudantV1.prototype.getDesignDocument = function (params) {
        var _params = __assign({}, params);
        var _requiredParams = ['db', 'ddoc'];
        var _validParams = ['db', 'ddoc', 'ifNoneMatch', 'attachments', 'attEncodingInfo', 'conflicts', 'deletedConflicts', 'latest', 'localSeq', 'meta', 'rev', 'revs', 'revsInfo', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'getDesignDocument');
        var parameters = {
            options: {
                url: '/{db}/_design/{ddoc}',
                method: 'GET',
    ...
    CloudantV1.prototype.putDesignDocument = function (params) {
        var _params = __assign({}, params);
        var _requiredParams = ['db', 'ddoc', 'designDocument'];
        var _validParams = ['db', 'ddoc', 'designDocument', 'ifMatch', 'batch', 'newEdits', 'rev', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'putDesignDocument');
        var parameters = {
            options: {
                url: '/{db}/_design/{ddoc}',
                method: 'PUT',
    ...
    CloudantV1.prototype.getDesignDocumentInformation = function (params) {
        var _params = __assign({}, params);
        var _requiredParams = ['db', 'ddoc'];
        var _validParams = ['db', 'ddoc', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'getDesignDocumentInformation');
        var parameters = {
            options: {
    ...
    CloudantV1.prototype.postDesignDocs = function (params) {
        var _params = __assign({}, params);
        var _requiredParams = ['db'];
        var _validParams = ['db', 'attEncodingInfo', 'attachments', 'conflicts', 'descending', 'includeDocs', 'inclusiveEnd', 'limit', 'skip', 'updateSeq', 'endKey', 'key', 'keys', 'startKey', 'accept', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'postDesignDocs');
        var parameters = {
            options: {
                url: '/{db}/_design_docs',
                method: 'POST',
    ...
    CloudantV1.prototype.postDesignDocsQueries = function (params) {
        var _params = __assign({}, params);
        var _requiredParams = ['db', 'queries'];
        var _validParams = ['db', 'queries', 'accept', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'postDesignDocsQueries');
        var parameters = {
            options: {
    ...
    CloudantV1.prototype.postView = function (params) {
        var _params = __assign({}, params);
        var _requiredParams = ['db', 'ddoc', 'view'];
        var _validParams = ['db', 'ddoc', 'view', 'attEncodingInfo', 'attachments', 'conflicts', 'descending', 'includeDocs', 'inclusiveEnd', 'limit', 'skip', 'updateSeq', 'endKey', 'endKeyDocId', 'group', 'groupLevel', 'key', 'keys', 'reduce', 'stable', 'startKey', 'startKeyDocId', 'update', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'postView');
        var parameters = {
            options: {
    ...
    CloudantV1.prototype.postViewAsStream = function (params) {
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'postViewAsStream');
        var parameters = {
            options: {
                url: '/{db}/_design/{ddoc}/_view/{view}',
                method: 'POST',
    ...
    CloudantV1.prototype.postViewQueries = function (params) {
        var _params = __assign({}, params);
        var _requiredParams = ['db', 'ddoc', 'view', 'queries'];
        var _validParams = ['db', 'ddoc', 'view', 'queries', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'postViewQueries');
        var parameters = {
            options: {
    ...
    CloudantV1.prototype.postViewQueriesAsStream = function (params) {
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'postViewQueriesAsStream');
        var parameters = {
            options: {
                url: '/{db}/_design/{ddoc}/_view/{view}/queries',
                method: 'POST',
    ...
    CloudantV1.prototype.getPartitionInformation = function (params) {
        var _params = __assign({}, params);
        var _requiredParams = ['db', 'partitionKey'];
        var _validParams = ['db', 'partitionKey', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'getPartitionInformation');
        var parameters = {
            options: {
    ...
    CloudantV1.prototype.postPartitionAllDocs = function (params) {
        var _params = __assign({}, params);
        var _requiredParams = ['db', 'partitionKey'];
        var _validParams = ['db', 'partitionKey', 'attEncodingInfo', 'attachments', 'conflicts', 'descending', 'includeDocs', 'inclusiveEnd', 'limit', 'skip', 'updateSeq', 'endKey', 'key', 'keys', 'startKey', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'postPartitionAllDocs');
        var parameters = {
            options: {
    ...
    CloudantV1.prototype.postPartitionAllDocsAsStream = function (params) {
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'postPartitionAllDocsAsStream');
        var parameters = {
            options: {
                url: '/{db}/_partition/{partition_key}/_all_docs',
                method: 'POST',
    ...
    CloudantV1.prototype.postPartitionSearch = function (params) {
        var _params = __assign({}, params);
        var _requiredParams = ['db', 'partitionKey', 'ddoc', 'index', 'query'];
        var _validParams = ['db', 'partitionKey', 'ddoc', 'index', 'query', 'bookmark', 'highlightFields', 'highlightNumber', 'highlightPostTag', 'highlightPreTag', 'highlightSize', 'includeDocs', 'includeFields', 'limit', 'sort', 'stale', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'postPartitionSearch');
        var parameters = {
            options: {
    ...
    CloudantV1.prototype.postPartitionSearchAsStream = function (params) {
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'postPartitionSearchAsStream');
        var parameters = {
            options: {
                url: '/{db}/_partition/{partition_key}/_design/{ddoc}/_search/{index}',
                method: 'POST',
    ...
    CloudantV1.prototype.postPartitionView = function (params) {
        var _params = __assign({}, params);
        var _requiredParams = ['db', 'partitionKey', 'ddoc', 'view'];
        var _validParams = ['db', 'partitionKey', 'ddoc', 'view', 'attEncodingInfo', 'attachments', 'conflicts', 'descending', 'includeDocs', 'inclusiveEnd', 'limit', 'skip', 'updateSeq', 'endKey', 'endKeyDocId', 'group', 'groupLevel', 'key', 'keys', 'reduce', 'startKey', 'startKeyDocId', 'update', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'postPartitionView');
        var parameters = {
            options: {
    ...
    CloudantV1.prototype.postPartitionViewAsStream = function (params) {
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'postPartitionViewAsStream');
        var parameters = {
            options: {
                url: '/{db}/_partition/{partition_key}/_design/{ddoc}/_view/{view}',
                method: 'POST',
    ...
    CloudantV1.prototype.postPartitionFind = function (params) {
        var _params = __assign({}, params);
        var _requiredParams = ['db', 'partitionKey', 'selector'];
        var _validParams = ['db', 'partitionKey', 'selector', 'bookmark', 'conflicts', 'executionStats', 'fields', 'limit', 'skip', 'sort', 'stable', 'update', 'useIndex', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'postPartitionFind');
        var parameters = {
            options: {
    ...
    CloudantV1.prototype.postPartitionFindAsStream = function (params) {
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'postPartitionFindAsStream');
        var parameters = {
            options: {
                url: '/{db}/_partition/{partition_key}/_find',
                method: 'POST',
    ...
    CloudantV1.prototype.postExplain = function (params) {
        var _params = __assign({}, params);
        var _requiredParams = ['db', 'selector'];
        var _validParams = ['db', 'selector', 'bookmark', 'conflicts', 'executionStats', 'fields', 'limit', 'skip', 'sort', 'stable', 'update', 'useIndex', 'r', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'postExplain');
        var parameters = {
            options: {
                url: '/{db}/_explain',
                method: 'POST',
    ...
    CloudantV1.prototype.postFind = function (params) {
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'postFind');
        var parameters = {
            options: {
                url: '/{db}/_find',
                method: 'POST',
    ...
    CloudantV1.prototype.postFindAsStream = function (params) {
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'postFindAsStream');
        var parameters = {
            options: {
                url: '/{db}/_find',
                method: 'POST',
    ...
    CloudantV1.prototype.getIndexesInformation = function (params) {
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'getIndexesInformation');
        var parameters = {
            options: {
                url: '/{db}/_index',
                method: 'GET',
    ...
    CloudantV1.prototype.postIndex = function (params) {
        var _params = __assign({}, params);
        var _requiredParams = ['db', 'index'];
        var _validParams = ['db', 'index', 'ddoc', 'def', 'name', 'partitioned', 'type', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'postIndex');
        var parameters = {
            options: {
                url: '/{db}/_index',
                method: 'POST',
    ...
    CloudantV1.prototype.deleteIndex = function (params) {
        var _params = __assign({}, params);
        var _requiredParams = ['db', 'ddoc', 'type', 'index'];
        var _validParams = ['db', 'ddoc', 'type', 'index', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'deleteIndex');
        var parameters = {
            options: {
    ...
    CloudantV1.prototype.postSearchAnalyze = function (params) {
        var _params = __assign({}, params);
        var _requiredParams = ['analyzer', 'text'];
        var _validParams = ['analyzer', 'text', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'postSearchAnalyze');
        var parameters = {
            options: {
                url: '/_search_analyze',
                method: 'POST',
    ...
    CloudantV1.prototype.postSearch = function (params) {
        var _params = __assign({}, params);
        var _requiredParams = ['db', 'ddoc', 'index', 'query'];
        var _validParams = ['db', 'ddoc', 'index', 'query', 'bookmark', 'highlightFields', 'highlightNumber', 'highlightPostTag', 'highlightPreTag', 'highlightSize', 'includeDocs', 'includeFields', 'limit', 'sort', 'stale', 'counts', 'drilldown', 'groupField', 'groupLimit', 'groupSort', 'ranges', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'postSearch');
        var parameters = {
            options: {
    ...
    CloudantV1.prototype.postSearchAsStream = function (params) {
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'postSearchAsStream');
        var parameters = {
            options: {
                url: '/{db}/_design/{ddoc}/_search/{index}',
                method: 'POST',
    ...
    CloudantV1.prototype.getSearchInfo = function (params) {
        var _params = __assign({}, params);
        var _requiredParams = ['db', 'ddoc', 'index'];
        var _validParams = ['db', 'ddoc', 'index', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'getSearchInfo');
        var parameters = {
            options: {
    ...
    CloudantV1.prototype.headReplicationDocument = function (params) {
        var _params = __assign({}, params);
        var _requiredParams = ['docId'];
        var _validParams = ['docId', 'ifNoneMatch', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'headReplicationDocument');
        var parameters = {
            options: {
    ...
    CloudantV1.prototype.headSchedulerDocument = function (params) {
        var _params = __assign({}, params);
        var _requiredParams = ['docId'];
        var _validParams = ['docId', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'headSchedulerDocument');
        var parameters = {
            options: {
    ...
    CloudantV1.prototype.headSchedulerJob = function (params) {
        var _params = __assign({}, params);
        var _requiredParams = ['jobId'];
        var _validParams = ['jobId', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'headSchedulerJob');
        var parameters = {
            options: {
    ...
    CloudantV1.prototype.deleteReplicationDocument = function (params) {
        var _params = __assign({}, params);
        var _requiredParams = ['docId'];
        var _validParams = ['docId', 'ifMatch', 'batch', 'rev', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'deleteReplicationDocument');
        var parameters = {
            options: {
                url: '/_replicator/{doc_id}',
                method: 'DELETE',
    ...
    CloudantV1.prototype.getReplicationDocument = function (params) {
        var _params = __assign({}, params);
        var _requiredParams = ['docId'];
        var _validParams = ['docId', 'ifNoneMatch', 'attachments', 'attEncodingInfo', 'conflicts', 'deletedConflicts', 'latest', 'localSeq', 'meta', 'rev', 'revs', 'revsInfo', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'getReplicationDocument');
        var parameters = {
            options: {
                url: '/_replicator/{doc_id}',
                method: 'GET',
    ...
    CloudantV1.prototype.putReplicationDocument = function (params) {
        var _params = __assign({}, params);
        var _requiredParams = ['docId', 'replicationDocument'];
        var _validParams = ['docId', 'replicationDocument', 'ifMatch', 'batch', 'newEdits', 'rev', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'putReplicationDocument');
        var parameters = {
            options: {
                url: '/_replicator/{doc_id}',
                method: 'PUT',
    ...
    CloudantV1.prototype.getSchedulerDocs = function (params) {
        var _params = __assign({}, params);
        var _requiredParams = [];
        var _validParams = ['limit', 'skip', 'states', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'getSchedulerDocs');
        var parameters = {
            options: {
                url: '/_scheduler/docs',
                method: 'GET',
    ...
    CloudantV1.prototype.getSchedulerDocument = function (params) {
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'getSchedulerDocument');
        var parameters = {
            options: {
                url: '/_scheduler/docs/_replicator/{doc_id}',
                method: 'GET',
    ...
    CloudantV1.prototype.getSchedulerJobs = function (params) {
        var _params = __assign({}, params);
        var _requiredParams = [];
        var _validParams = ['limit', 'skip', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'getSchedulerJobs');
        var parameters = {
            options: {
                url: '/_scheduler/jobs',
                method: 'GET',
    ...
    CloudantV1.prototype.getSchedulerJob = function (params) {
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'getSchedulerJob');
        var parameters = {
            options: {
                url: '/_scheduler/jobs/{job_id}',
                method: 'GET',
    ...
    CloudantV1.prototype.getSessionInformation = function (params) {
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'getSessionInformation');
        var parameters = {
            options: {
                url: '/_session',
                method: 'GET',
    ...
    CloudantV1.prototype.getSecurity = function (params) {
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'getSecurity');
        var parameters = {
            options: {
                url: '/{db}/_security',
                method: 'GET',
    ...
    CloudantV1.prototype.putSecurity = function (params) {
        var _params = __assign({}, params);
        var _requiredParams = ['db'];
        var _validParams = ['db', 'admins', 'members', 'cloudant', 'couchdbAuthOnly', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'putSecurity');
        var parameters = {
            options: {
                url: '/{db}/_security',
                method: 'PUT',
    ...
    CloudantV1.prototype.postApiKeys = function (params) {
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'postApiKeys');
        var parameters = {
            options: {
    ...
    CloudantV1.prototype.putCloudantSecurityConfiguration = function (params) {
        var _params = __assign({}, params);
        var _requiredParams = ['db', 'cloudant'];
        var _validParams = ['db', 'cloudant', 'admins', 'members', 'couchdbAuthOnly', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'putCloudantSecurityConfiguration');
        var parameters = {
            options: {
    ...
    CloudantV1.prototype.getCorsInformation = function (params) {
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'getCorsInformation');
        var parameters = {
            options: {
    ...
    CloudantV1.prototype.putCorsConfiguration = function (params) {
        var _params = __assign({}, params);
        var _requiredParams = ['origins'];
        var _validParams = ['origins', 'allowCredentials', 'enableCors', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'putCorsConfiguration');
        var parameters = {
            options: {
                url: '/_api/v2/user/config/cors',
                method: 'PUT',
    ...
    CloudantV1.prototype.headAttachment = function (params) {
        var _params = __assign({}, params);
        var _requiredParams = ['db', 'docId', 'attachmentName'];
        var _validParams = ['db', 'docId', 'attachmentName', 'ifMatch', 'ifNoneMatch', 'rev', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'headAttachment');
        var parameters = {
            options: {
    ...
    CloudantV1.prototype.deleteAttachment = function (params) {
        var _params = __assign({}, params);
        var _requiredParams = ['db', 'docId', 'attachmentName'];
        var _validParams = ['db', 'docId', 'attachmentName', 'ifMatch', 'rev', 'batch', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'deleteAttachment');
        var parameters = {
            options: {
                url: '/{db}/{doc_id}/{attachment_name}',
                method: 'DELETE',
    ...
    CloudantV1.prototype.getAttachment = function (params) {
        var _params = __assign({}, params);
        var _requiredParams = ['db', 'docId', 'attachmentName'];
        var _validParams = ['db', 'docId', 'attachmentName', 'accept', 'ifMatch', 'ifNoneMatch', 'range', 'rev', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'getAttachment');
        var parameters = {
            options: {
                url: '/{db}/{doc_id}/{attachment_name}',
                method: 'GET',
    ...
    CloudantV1.prototype.putAttachment = function (params) {
        var _params = __assign({}, params);
        var _requiredParams = ['db', 'docId', 'attachmentName', 'attachment', 'contentType'];
        var _validParams = ['db', 'docId', 'attachmentName', 'attachment', 'contentType', 'ifMatch', 'rev', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'putAttachment');
        var parameters = {
            options: {
                url: '/{db}/{doc_id}/{attachment_name}',
                method: 'PUT',
    ...
    CloudantV1.prototype.headLocalDocument = function (params) {
        var _params = __assign({}, params);
        var _requiredParams = ['db', 'docId'];
        var _validParams = ['db', 'docId', 'ifNoneMatch', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'headLocalDocument');
        var parameters = {
            options: {
    ...
    CloudantV1.prototype.deleteLocalDocument = function (params) {
        var _params = __assign({}, params);
        var _requiredParams = ['db', 'docId'];
        var _validParams = ['db', 'docId', 'batch', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'deleteLocalDocument');
        var parameters = {
            options: {
                url: '/{db}/_local/{doc_id}',
                method: 'DELETE',
    ...
    CloudantV1.prototype.getLocalDocument = function (params) {
        var _params = __assign({}, params);
        var _requiredParams = ['db', 'docId'];
        var _validParams = ['db', 'docId', 'accept', 'ifNoneMatch', 'attachments', 'attEncodingInfo', 'localSeq', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'getLocalDocument');
        var parameters = {
            options: {
                url: '/{db}/_local/{doc_id}',
                method: 'GET',
    ...
    CloudantV1.prototype.putLocalDocument = function (params) {
        var _params = __assign({}, params);
        var _requiredParams = ['db', 'docId', 'document'];
        var _validParams = ['db', 'docId', 'document', 'contentType', 'batch', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'putLocalDocument');
        var parameters = {
            options: {
                url: '/{db}/_local/{doc_id}',
                method: 'PUT',
    ...
    CloudantV1.prototype.postRevsDiff = function (params) {
        var _params = __assign({}, params);
        var _requiredParams = ['db', 'documentRevisions'];
        var _validParams = ['db', 'documentRevisions', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'postRevsDiff');
        var parameters = {
            options: {
                url: '/{db}/_revs_diff',
                method: 'POST',
    ...
    CloudantV1.prototype.getShardsInformation = function (params) {
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'getShardsInformation');
        var parameters = {
            options: {
                url: '/{db}/_shards',
                method: 'GET',
    ...
    CloudantV1.prototype.getDocumentShardsInfo = function (params) {
        var _params = __assign({}, params);
        var _requiredParams = ['db', 'docId'];
        var _validParams = ['db', 'docId', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'getDocumentShardsInfo');
        var parameters = {
            options: {
    ...
    CloudantV1.prototype.headUpInformation = function (params) {
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'headUpInformation');
        var parameters = {
            options: {
                url: '/_up',
                method: 'HEAD',
    ...
    CloudantV1.prototype.getActiveTasks = function (params) {
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'getActiveTasks');
        var parameters = {
            options: {
                url: '/_active_tasks',
                method: 'GET',
    ...
    CloudantV1.prototype.getUpInformation = function (params) {
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'getUpInformation');
        var parameters = {
            options: {
                url: '/_up',
                method: 'GET',
    ...
    CloudantV1.prototype.getActivityTrackerEvents = function (params) {
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'getActivityTrackerEvents');
        var parameters = {
            options: {
    ...
    CloudantV1.prototype.postActivityTrackerEvents = function (params) {
        var _params = __assign({}, params);
        var _requiredParams = ['types'];
        var _validParams = ['types', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'postActivityTrackerEvents');
        var parameters = {
            options: {
                url: '/_api/v2/user/activity_tracker/events',
                method: 'POST',
    ...
    CloudantV1.prototype.getCurrentThroughputInformation = function (params) {
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(CloudantV1.DEFAULT_SERVICE_NAME, 'v1', 'getCurrentThroughputInformation');
        var parameters = {
            options: {
